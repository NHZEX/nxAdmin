 ...
 * @return array
 *
 * @see https://stackoverflow.com/a/11943744/10242420
 */
...
function trim_root_path(string $content, string $replace = ''): string
{
    return str_replace(rtrim(root_path(), '\\\/'), $replace, $content);
}
